...
# endif
  ...
  OPEN(95,FILE='MESHLOG.LOG',STATUS='UNKNOWN')
  CLOSE(95,STATUS='DELETE')
  OPEN(95,FILE='MESHLOG.LOG',STATUS='UNKNOWN', POSITION='APPEND')
  errorIndex=0
!
!---------------interior cells-----------------------------------------!
!
...
# endif
       ...
       if(abs(temp1).lt.1.e-6_SP)  then
         ...
         print*, 'x1*y2==',x1*y2
         print*, 'x2*y1==',x2*y1
         WRITE(95,*) 'Mesh error. Element index:',i
