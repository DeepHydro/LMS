...
!============ END PETSc BLOCK ========================================================
  ...
  USE ALL_VARS, ONLY : NVG, MSR, NGL, MGL, MT, NPROCS, MYID, M, IPT
  IMPLICIT NONE
...
!          except:  m,kbm1
!============================================================================
  USE ALL_VARS , ONLY : M, NTSN, NBSN, MGL
  IMPLICIT NONE
  ...
  CALL MatCreateMPIAIJ(MPI_COMM_WORLD,N_VERTS,N_VERTS,MGL,MGL,0,DNNZ2,0,ONNZ2,A_EL,IERR);CHKERRQ(IERR)
