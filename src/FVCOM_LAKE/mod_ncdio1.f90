...
!------------------------------------------------------------------------------|
   ...
   if(status /=nf_noerr)then
     ...
     write(ipt,*)trim(nf_strerror(status))
     call pstop
   end if
...
!--Create File 
   ierr = nf_create(path=cdfname,cmode=nf_clobber,ncid=nc_ofid)
...
!--Description of File Contents
   ierr = nf90_put_att(nc_ofid,nf_global,"title"      ,trim(casetitle))
   ierr = nf90_put_att(nc_ofid,nf_global,"institution",trim(institution))
   ierr = nf90_put_att(nc_ofid,nf_global,"source"     ,trim(fvcom_version))
   ierr = nf90_put_att(nc_ofid,nf_global,"history"    ,trim(timestamp))
   ierr = nf90_put_att(nc_ofid,nf_global,"references" ,trim(fvcom_website))
   ierr = nf90_put_att(nc_ofid,nf_global,"Conventions",trim(netcdf_convention))
#  if defined (SPHERICAL)
   ierr = nf90_put_att(nc_ofid,nf_global,"CoordinateSystem","GeoReferenced")
#endif



!--Define Fixed Model Dimensions 
   ierr = nf_def_dim(nc_ofid,"scalar" ,1      ,scl_did    )        
   ierr = nf_def_dim(nc_ofid,"node"   ,mgl    ,node_did   )        
   ierr = nf_def_dim(nc_ofid,"nele"   ,ngl    ,nele_did   )
   ierr = nf_def_dim(nc_ofid,"siglay" ,kbm1   ,siglay_did )
   ierr = nf_def_dim(nc_ofid,"siglev" ,kb     ,siglev_did )
   ierr = nf_def_dim(nc_ofid,"three"  ,3      ,three_did  )
   ierr = nf_def_dim(nc_ofid,"four"   ,4      ,four_did   )

!--Define Unlimited Model Dimension
   ierr = nf_def_dim(nc_ofid,"time"   ,nf_unlimited,time_did)
...
!--Define Coordinate Variables and Attributes
   ...
   ierr = nf_def_var(nc_ofid,"nprocs",nf90_int,stat_scl,nprocs_vid)
   ierr = nf90_put_att(nc_ofid,nprocs_vid,"long_name","number of processors")

   !!====PARTITION: Partion Number of Element===============!
   ierr = nf_def_var(nc_ofid,"partition",nf90_int,stat2de,partition_vid)
   ...
   ierr = nf_def_var(nc_ofid,"Initial_Density",nf90_float,stat3dn_lay,idens_vid)
   ...
   ierr = nf_def_var(nc_ofid,"x",nf90_float,stat2dn,x_vid)
   ...
   ierr = nf_def_var(nc_ofid,"y",nf90_float,stat2dn,y_vid)
   ...
   ierr = nf_def_var(nc_ofid,"lon",nf90_float,stat2dn,lon_vid)
   ...
   ierr = nf_def_var(nc_ofid,"lat",nf90_float,stat2dn,lat_vid)
   ...
   ierr = nf_def_var(nc_ofid,"siglay",nf90_float,stat3dn_lay,siglay_vid)
   ...
   ierr = nf_def_var(nc_ofid,"siglay_shift",nf90_float,stat3dn_lay,siglay_shift_vid)
   ierr = nf90_put_att(nc_ofid,siglay_shift_vid,"long_name","Shifted Sigma Layers")

   !!====Sigma Coordinate for Sigma Levels (Z)   (-)========!
   ierr = nf_def_var(nc_ofid,"siglev",nf90_float,stat3dn_lev,siglev_vid)
...
!--Define Mesh Relevant Variables and Attributes
   ...
   ierr = nf_def_var(nc_ofid,"h",nf90_float,stat2dn,h_vid)
   ...
   ierr = nf_def_var(nc_ofid,"nv",nf90_int,specdim,nv_vid)
   ...
   ierr = nf_def_var(nc_ofid,"a1u",nf90_float,specdim,a1u_vid)
   ierr = nf90_put_att(nc_ofid,a1u_vid,"long_name","a1u")
   ierr = nf_def_var(nc_ofid,"a2u",nf90_float,specdim,a2u_vid)
   ierr = nf90_put_att(nc_ofid,a2u_vid,"long_name","a2u")

   !!====Element Based Interpolation Coefficients===========!
   specdim = (/nele_did,three_did/) 
   ierr = nf_def_var(nc_ofid,"aw0",nf90_float,specdim,aw0_vid)
   ierr = nf90_put_att(nc_ofid,aw0_vid,"long_name","aw0")
   ierr = nf_def_var(nc_ofid,"awx",nf90_float,specdim,awx_vid)
   ierr = nf90_put_att(nc_ofid,awx_vid,"long_name","awx")
   ierr = nf_def_var(nc_ofid,"awy",nf90_float,specdim,awy_vid)
   ierr = nf90_put_att(nc_ofid,awy_vid,"long_name","awy")

!--Define Model Time Variables and Attributes    
   ierr = nf_def_var(nc_ofid,"time",nf90_float,dynmtime,time_vid)
   ...
   ierr = nf_def_var(nc_ofid,"iint",nf90_int,dynmtime,iint_vid)
...
!--Define Time Dependent Flow Variables (selected by user from input file)
   do i=1,nout_vars
     ...
     case("u")  !!===============u=======================================!
     ierr = nf_def_var(nc_ofid,"u",nf90_float,dynm3de_lay,u_vid)
     ...
     case("v")  !!===============v=======================================!
     ierr = nf_def_var(nc_ofid,"v",nf90_float,dynm3de_lay,v_vid)
     ...
     case("ww") !!===============ww======================================!
     ierr = nf_def_var(nc_ofid,"ww",nf90_float,dynm3de_lay,ww_vid)
     ...
     case("km") !!===============km======================================!
     ierr = nf_def_var(nc_ofid,"km",nf90_float,dynm3dn_lev,km_vid)
     ...
     case("kh") !!===============kh======================================!
     ierr = nf_def_var(nc_ofid,"kh",nf90_float,dynm3dn_lev,kh_vid)
     ...
     case("t1") !!===============t1======================================!
     ierr = nf_def_var(nc_ofid,"temp",nf90_float,dynm3dn_lay,t1_vid)
     ...
     case("s1") !!===============s1======================================!
     ierr = nf_def_var(nc_ofid,"salinity",nf90_float,dynm3dn_lay,s1_vid)
     ...
     case("el") !!===============el======================================!
     ierr = nf_def_var(nc_ofid,"zeta",nf90_float,dynm2dn,el_vid)
     ...
     case("d") !!===============d=======================================!
     ierr = nf_def_var(nc_ofid,"depth",nf90_float,dynm2dn,d_vid)
     ...
     case("ua") !!===============ua======================================!
     ierr = nf_def_var(nc_ofid,"ua",nf90_float,dynm2de,ua_vid)
     ...
     case("va") !!===============va======================================!
     ierr = nf_def_var(nc_ofid,"va",nf90_float,dynm2de,va_vid)
...
#  if defined (DYE_RELEASE)      
    case("dye") !!===============dye====================================!
    ierr = nf_def_var(nc_ofid,"dye",nf90_float,dynm3dn_lay,dye_vid)
...
#  if defined (ICE)
    case("aice") !!===============ice====================================!
    ierr = nf_def_var(nc_ofid,"aice",nf90_float,dynm2dn,aice_vid)
    ...
    case("vice") !!===============ice====================================!
    ierr = nf_def_var(nc_ofid,"vice",nf90_float,dynm2dn,vice_vid)
    ...
    case("vsno") !!===============ice====================================!
    ierr = nf_def_var(nc_ofid,"vsno",nf90_float,dynm2dn,vsno_vid)
    ...
    case("eice") !!===============ice====================================!
    ierr = nf_def_var(nc_ofid,"eice",nf90_float,dynm2dn,eice_vid)
    ...
    case("esno") !!===============ice====================================!
    ierr = nf_def_var(nc_ofid,"esno",nf90_float,dynm2dn,esno_vid)
    ...
    case("uuice") !!===============ice====================================!
    ierr = nf_def_var(nc_ofid,"uuice",nf90_float,dynm2de,uuice_vid)
    ...
    case("vvice") !!===============ice====================================!
    ierr = nf_def_var(nc_ofid,"vvice",nf90_float,dynm2de,vvice_vid)
    ...
    case("tair") !!===============ice====================================!
    ierr = nf_def_var(nc_ofid,"tair",nf90_float,dynm2dn,tair_vid)
    ...
    case("qa") !!===============ice====================================!
    ierr = nf_def_var(nc_ofid,"qa_air",nf90_float,dynm2dn,qa_vid)
    ...
    case("pa") !!===============ice====================================!
    ierr = nf_def_var(nc_ofid,"pa_air",nf90_float,dynm2dn,pa_vid)
    ...
    case("sw") !!===============ice====================================!
    ierr = nf_def_var(nc_ofid,"SW",nf90_float,dynm2dn,sw_vid)
    ...
    case("nheat") !!===============ice====================================!
    ierr = nf_def_var(nc_ofid,"nheat",nf90_float,dynm2dn,nheat_vid)
...
#   endif
    ...
    case("uuwind") !!===============wind====================================!
    ierr = nf_def_var(nc_ofid,"uuwind",nf90_float,dynm2de,uuwind_vid)
    ...
    case("vvwind") !!===============wind====================================!
    ierr = nf_def_var(nc_ofid,"vvwind",nf90_float,dynm2de,vvwind_vid)
...
#  if defined (WET_DRY)
     ...
     ierr = nf_def_var(nc_ofid,"wd",nf90_float,dynm2dn,wd_vid)
...
!ex  case("var") !!===============var====================================!
!ex  ierr = nf_def_var(nc_ofid,"truevar",nf90_float,dimensions,var_vid)
...
#  if defined (SEDIMENT)
   if(Nsed > 0)then
     ...
     do i=1,Nsed
       ierr = nf_def_var(nc_ofid,trim(sed(i)%sname),nf90_float,dynm3dn_lay,itmp)
       ierr = nf90_put_att(nc_ofid,itmp,"long_name",trim(sed(i)%sname))
       ierr = nf90_put_att(nc_ofid,itmp,"units","kg m^-3")
       sc_vid(i) = itmp
     end do
     ierr = nf_def_var(nc_ofid,'accruement',nf90_float,dynm2dn,ac_vid)
